...
<br/><br/>
It requires API keys from xAI and this 3rd party API from RapidAPI for Google Trends data: https://rapidapi.com/superbapi-superbapi-default/api/google-trends-api4 - requires the basic plan.<br/>
...
<b>2.1.26</b>: Made some updates and the wordcloud and piechart now use the same data source which is obtained by the hourly scraper, hence the entries below are commented out. Those files are no longer used and categorize_and_chart.php and generate_wordcloud_chartjs.php have been updated to use the correct data sources.
